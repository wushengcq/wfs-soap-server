...
<xsd:schema 
	...
	xmlns:testbed12="http://gci.asu.edu/testbed12" 
	xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
	elementFormDefault="qualified" 
	targetNamespace="http://gci.asu.edu/testbed12">
<xsd:import namespace="http://www.opengis.net/gml" 
	schemaLocation="http://polar.geodacenter.org:80/geoserver29/schemas/gml/3.1.1/base/gml.xsd"/>
	 */
	...
	public String describe(List<QName> featureNames) throws NullPointerException, IOException, TransformerException {		
		...
		sb.append("namespace='http://www.opengis.net/gml' ");
		sb.append("schemaLocation='http://schemas.opengis.net/gml/3.1.1/base/gml.xsd' />");
	...
	private String describe(String featureName) throws IOException, TransformerException {
		...
		sb.append("substitutionGroup='gml:_Feature' ");
	...
	protected String[] getAcceptVersions() {
		return new String[]{Constant.WFS_VERSION_1_1};
	}
}
